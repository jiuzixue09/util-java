...
public class Matrix {
    ...
    public static void main(String[] args) {
        ...
        StdOut.print(Arrays.deepToString(d));
        StdOut.println();

        StdOut.println("I");
        StdOut.println("--------------------");
        double[][] c = Matrix.identity(5);
        StdOut.print(Arrays.deepToString(c));
        StdOut.println();

        StdOut.println("A");
        StdOut.println("--------------------");
        double[][] a = Matrix.random(5, 5);
        StdOut.print(Arrays.deepToString(a));
        StdOut.println();
        ...
        StdOut.print(Arrays.deepToString(e));
        StdOut.println();

        StdOut.println("A * A^T");
        StdOut.println("--------------------");
        double[][] f = Matrix.multiply(a, b);
        StdOut.print(Arrays.deepToString(f));
        StdOut.println();
    }
}